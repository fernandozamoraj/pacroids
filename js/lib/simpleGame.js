...
//there is just no friendly way to check for touch screen since chrome says
//the browser is always touchable
//this will address 80% of mobile vs. desktop instances
//:-(
function isMobile() {
    var check = false;
